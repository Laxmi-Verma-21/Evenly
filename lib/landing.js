...
export const FEATURES = [
  ...
  },
  {
    ...
    color: "text-green-600",
    description:
      "Split equally, by percentage, or by exact amounts to fit any expense type.",
  ...
  },
  {
    ...
    color: "text-teal-600",
    description:
      "See all new expenses and repayments the moment your friends add them.",
  },
];
...
export const TESTIMONIALS = [
  {
    quote:
      "I always used to say ‘Aal Izz Well’ after every expense. But Now I just say ‘ Evenly karega sab well! ’",
    name: "Rancho",
    image: "/testimonials/rancho.png",
    role: "Engineer",
  },
  {
    quote:
      "Even my gang in Gokul Dham uses Evenly. Bhide stopped chasing Taarak for society funds!",
    name: "Jethalal",
    image: "/testimonials/jethalal.jpg",
    role: "Businessman",
  },
  {
    quote:
      "Earlier my friends forgot who paid for snacks. Now, thanks to Splitr, even ‘Circuit’ can’t escape paying!",
    name: "Munna Bhai",
    image: "/testimonials/munna.jpg",
    role: "Social Worker ",
  },
];